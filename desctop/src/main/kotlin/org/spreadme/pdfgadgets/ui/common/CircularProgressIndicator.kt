...
import org.spreadme.pdfgadgets.utils.toRgbaHexString

@Composable
fun CircularProgressIndicator(
    modifier: Modifier = Modifier,
    size: DpSize = DpSize(32.dp, 32.dp),
    style: CircularProgressStyle = CircularProgressStyle(color = MaterialTheme.colors.primary),
) {
...
private fun CircularProgressIndicatorImpl(
    ...
    val defaultColor = if (PDFGadgetsTheme.isDark) Color(0xFF6F737A) else Color(0xFFA8ADBD)
