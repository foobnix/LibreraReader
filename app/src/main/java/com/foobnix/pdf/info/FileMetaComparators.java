...
public class FileMetaComparators {
    ...
    public static Comparator<SimpleMeta> BY_DATE_SIMPLE_META = new Comparator<SimpleMeta>() {
        @Override public int compare(SimpleMeta o1, SimpleMeta o2) {
            try {
    ...
    public static Comparator<FileMeta> DIRS = new Comparator<FileMeta>() {
        @Override public int compare(FileMeta o1, FileMeta o2) {
            if (o1.getCusType() != null && o1.getCusType() == FileMetaAdapter.DISPLAY_TYPE_DIRECTORY &&
                o2.getCusType() == null) {
                return -1;
            }
            if (o2.getCusType() != null && o2.getCusType() == FileMetaAdapter.DISPLAY_TYPE_DIRECTORY &&
                o1.getCusType() == null) {
                return 1;
            }
