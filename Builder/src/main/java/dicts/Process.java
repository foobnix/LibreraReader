...
public class Process {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final String DB = "/data/Downloads/replaces/db/sample.db";
        ...
        try {
            ...
            //String in = "/data/Downloads/replaces/db/in.txt";
            String in = "/data/Downloads/replaces/db/polnaya_akceptuirovannaya_paradigma.dict";
