...
public class Process2 {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        String file = "/home/dev/Downloads/replaces/db/odict/zalizniak.txt";
        String outFile = "/home/dev/Downloads/replaces/db/odict/Librera_Словарь_Ударений_[odict.ru].txt";
