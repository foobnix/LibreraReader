...
public class DescriptionTranslation {
    ...
    private static final String TR_PATH = "/home/dev/git/LibreraReader/Builder/Description/about/";
    private static final String RECENT_PATH = "/home/dev/git/LibreraReader/Builder/Description/recent/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String aboutEN = new String(Files.readAllBytes(Paths.get("/home/dev/git/LibreraReader/Builder/Description/about.txt")));
        String recentEN = new String(Files.readAllBytes(Paths.get("/home/dev/git/LibreraReader/Builder/Description/recent.txt")));
