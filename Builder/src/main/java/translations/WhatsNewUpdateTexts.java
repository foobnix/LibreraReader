...
public class WhatsNewUpdateTexts {
    ...
    private static final String RECENT_PATH = LocalPaths.repo("Builder/src/whatsnew/");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String recentEN = new String(Files.readAllBytes(Paths.get(LocalPaths.repo("Builder/src/whatsnew/recent.txt"))));
