...
#define MOBI_ATTRNAME_MAXSIZE 200 /**< Maximum length of tag attribute name, like "href" */
#define MOBI_ATTRVALUE_MAXSIZE 200 /**< Maximum length of tag attribute value */
