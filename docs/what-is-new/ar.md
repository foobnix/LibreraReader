...
### [[8.6.44]](/download/ar) تدوير واقتصاص في القائمة السفلية
<img class="i" src="8.6.44.png" />


### [[8.6.43]](/download/ar) تدوير 90 درجة ، وقطع الحدود البيضاء ، ومقطع إلى صفحتين

||||
|-|-|-|
|![](8.6.43a.png)|![](8.6.43b.png)|![](8.6.43c.png)|

### [[8.6.41]](/download/ar) عرض اسم السلسلة ، الترتيب حسب فهرس السلسلة
<img class="i" src="8.6.41.png" />

### [[8.6.40]](/download/ar) هيئ ما سيتم عرضه في علامة تبويب المفضلة
